...
export class LocationViewComponent extends BaseComponent implements OnInit {
    ...
    initForm(): void {
        this.locationForm = this.fb.group({
            ...
            organizationId: [0],
            opearationCenter: ['مركز العمليات الرئيسي'],
            openingDate: ['2024-01-01'],
            siteLocation: ['الرياض'],
            siteCoordinates: ['24.7136,46.6753'],
            siteReceiptDate: ['2024-02-01'],
            nearestPoliceStation: ['مركز شرطة العليا'],
            nearestDefenseCenter: ['مركز الدفاع المدني'],
            siteLength: ['150م'],
            northBoundar: ['شارع الملك'],
            southBoundar: ['طريق الخدمة'],
            westBoundar: ['حي الربيع'],
            eastBoundar: ['طريق الدائري'],
            siteType: ['Found'],
            locationClassificationId: [1],
            administrativeSite: ['مبنى الإدارة'],
            administrativeSiteDistance: ['2 كم'],
            administrativeSiteType: ['إداري'],
            administrativeOfficeNumber: [3],
            administrativeWCNumber: [6],
            administrativeServiceNumber: [2],
            weaponsWarehouse: [true],
            warhouseArea: ['120 م2'],
            maintainceWorkShop: [true],
            parkingSpaces: [true],
            parkingSpacesNumber: [25],
            staff: [40],
        });
    }

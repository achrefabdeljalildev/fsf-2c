...
import { FallingLoadClassificationService } from '../../services/falling-load-classification.service';
...
export class FallingLoadClassificationViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: FallingLoadClassificationService,
    ) {
        super();
    }

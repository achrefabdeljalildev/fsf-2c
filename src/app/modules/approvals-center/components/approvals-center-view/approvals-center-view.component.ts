...
@Component({
    selector: 'app-approvals-center-view',
    templateUrl: './approvals-center-view.component.html',
    standalone: false,
})
export class approvalsCenterViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: approvalsCenterService,
    ) {
        super();
    }

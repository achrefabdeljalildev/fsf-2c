...
@Component({
    selector: 'app-duty-shifts-view',
    templateUrl: './duty-shifts-view.component.html',
    standalone: false,
})
export class dutyShiftsViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: dutyShiftsService,
    ) {
        super();
    }

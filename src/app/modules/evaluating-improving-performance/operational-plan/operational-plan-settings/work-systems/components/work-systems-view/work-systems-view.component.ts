...
@Component({
    selector: 'app-work-systems-view',
    templateUrl: './work-systems-view.component.html',
    standalone: false,
})
export class WorkSystemsViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: WorkSystemsService,
    ) {
        super();
    }

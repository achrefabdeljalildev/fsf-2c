...
@Component({
    selector: 'app-list-of-sites-view',
    templateUrl: './list-of-sites-view.component.html',
    standalone: false,
})
export class listOfSitesViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: listOfSitesService,
    ) {
        super();
    }

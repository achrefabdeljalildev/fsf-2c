...
@Component({
    selector: 'app-duty-officers-view',
    templateUrl: './duty-officers-view.component.html',
    standalone: false,
})
export class dutyOfficersViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: dutyOfficersService,
    ) {
        super();
    }

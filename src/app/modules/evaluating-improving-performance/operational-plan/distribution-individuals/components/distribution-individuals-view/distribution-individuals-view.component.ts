...
@Component({
    selector: 'app-distrybution-individuals-view',
    templateUrl: './distribution-individuals-view.component.html',
    standalone: false,
})
export class distributionIndividualsViewComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        private service: distributionIndividualsService,
    ) {
        super();
    }
